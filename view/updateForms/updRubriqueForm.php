...
<div class="wrapper ">
    ...
    <div class="row justify-content-center">
        <div class="col-10 col-sm-12 col-md-11 col-lg-10 ">
            ...
            <h1 class="mt-5">Modifier une rubrique.</h1>
            ...
            <form class="updRubrique-form" 
            action="index.php?action=ModifRubrique&g=<?=$idGroupe?>&idRubrique=<?=$oldRub->idRubrique()?>" method="post" autocomplete="off">

                <div class="text-input col-md-9 col-lg-8 ">
                    <input type="text" name="nomRubrique" class="col-12 light-input" id="nomRubrique" 
                    value="<?=$oldRub->nomRubrique()?>" autofocus>
