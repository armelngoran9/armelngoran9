    ...
    <div class="container pt-5">
        ...
        <div class="row justify-content-center">
            <div class="col-10 col-sm-12 col-md-11 col-lg-10 ">
                ...
                <h1 class="mt-5">Créer un Groupe.</h1>

                <form class="groupe-form" action="index.php?action=AjoutGroupe&z=<?=$nomZone?>" method="post" autocomplete="off">

                    <div class="text-input col-md-10 col-lg-9 ">
                        <input type="text" name="nomGroupe" class="col-12 light-input" id="nomGroupe" autofocus>
                    ...
                    <div class="text-input col-md-10 col-lg-9 ">
                        <input type="text" name="nomRespo" class="col-12 light-input" id="nomRespo" autofocus>
                    ...
                    <div class="text-input col-md-10 col-lg-9 ">
                        <input type="text" name="nomTreso" class="col-12 light-input" id="nomTreso" autofocus>
                ...
                <a class="mt-4 d-block" href="index.php?action=ListeGroupes&z=<?=$nomZone?>">Revenir à la liste des zones</a>
            </div>
        </div>
    </div>
